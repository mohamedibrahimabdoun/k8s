...
```bash
$ gcloud projects create demi-docker-k8s-workshop --name="demi-docker-k8s-workshop"
...
$ gcloud projects describe demi-docker-k8s-workshop
...
$ gcloud config set project demi-docker-k8s-workshop
...
$ gcloud beta billing projects link demi-docker-k8s-workshop --billing-account="001122-AA0011-4422BB"
...
$ gcloud container clusters create k8s-apps
...
```bash
$ gcloud container clusters describe k8s-apps
addonsConfig:
  networkPolicyConfig:
    disabled: true
